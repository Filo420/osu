...
namespace osu.Game.Tests.Visual.Gameplay
{
    public partial class TestSceneBeatmapHitsoundsControl : OsuTestScene
    {
        ...
        [Test]
        public void TestCorrectBehaviourOnFirstLoad()
        {
            ...
            AddStep("change the current value to false", () => hitsoundsControl.Current.Value = false);
            AddAssert("control shows hitsounds disabled", () => !hitsoundsControl.Current.Value);

            recreateControl();
            AddAssert("control shows hitsounds disabled after reload", () => !hitsoundsControl.Current.Value);
        }
